...
import FifthRaatContent from '@/components/FifthRaat';
import Footer from '@/components/Footer';
import FourthRaat from '@/components/Fourthraat';
import PehliRaatContent from '@/components/PehliRaatContent'
import { Button } from '@/components/ui/button';
import useCurrentUser from '@/lib/hooks/useCurrentUser';

export default function FifthRaat() {
    ...
    return (
        <div className="flex flex-col min-h-screen text-foreground">
            ...
            <main className="flex-1 container mx-auto px-4 py-8">
                ...
                <div className="mt-8">
                    <FifthRaatContent currentUser={currentUser} />
                </div>
            </main>
            <Footer />
        </div>
