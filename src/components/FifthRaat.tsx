...
interface FifthRaatContentProps {
  currentUser: User | null; // Pass currentUser as a prop
}

export default function FifthRaatContent({ currentUser }: FifthRaatContentProps) {
  const EVENT_ID = 4;
  ...
  return (
    <>
      <h1 className="text-xl md:text-2xl font-semibold text-primary-green mb-4">5mi Raat Majlis & Jaman</h1>
